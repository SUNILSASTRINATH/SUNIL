...
<body>
	...
	<form action="TakeReort" method="post">
		<div class="panel-footer">
			<!-- <label for="start">Select date:</label> <input type="date"
				id="datefield" name="reportDate" value="2020-05-21" min="1990-01-01"
				max=""> -->
			<a href="exportCSV.jsp"><button type="button">Take
					Report</button></a>
		</div>
	</form>
	<form action="SubmitReort" method="post">
		<div class="panel-footer">
			<!-- <label for="start">Select date:</label> <input type="date"
				id="datefield" name="reportDate" value="2020-05-21" min="1990-01-01"
				max=""> -->
			<a href="exportCSV.jsp"><button type="button">Submit
					Report</button></a>
		</div>
	</form>
