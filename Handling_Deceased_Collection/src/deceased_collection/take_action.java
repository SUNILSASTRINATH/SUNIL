...
public class take_action implements CollectorDAO {
	...
	public Collector getCollector(String cid, String lid, String aid, double amount, double selling_price,double collateral_info)
 {
		...
		try {
			con = MyConnection.getCon();
			String sqlQuery = "UPDATE report SET amount = amount - selling_price-collateral_info WHERE cid = ? and lid = ? and aid = ?";
